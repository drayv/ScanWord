...
namespace ScanWord.Core.Data
{
    ...
    public interface IScanDataRepository
    {
        ...
        Task BulkAddFilesAsync(ConcurrentBag<File> files);
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        Task BulkAddWordsAsync(ConcurrentBag<Word> words);
        ...
        /// <param name="compositions">Collection of compositions.</param>
        /// <returns>The <see cref="Task"/>.</returns>
        Task BulkAddCompositionsAsync(ConcurrentBag<Composition> compositions);
